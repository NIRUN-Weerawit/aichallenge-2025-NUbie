...
namespace simple_pure_pursuit
{
        ...
        steering_tire_angle_gain_(declare_parameter<float>("steering_tire_angle_gain", 1.0))
  {
    ...
    pub_closest_point_ = create_publisher<PointStamped>("/control/debug/closest_point", 1);
  ...
  void SimplePurePursuit::onTimer()
  {
    ...
    TrajectoryPoint closet_traj_point = trajectory_->points.at(closest_traj_point_idx);
    ...
    closest_point_msg.header.stamp = get_clock()->now();
    closest_point_msg.header.frame_id = "map";
    closest_point_msg.point.x = closet_traj_point.pose.position.x;
    closest_point_msg.point.y = closet_traj_point.pose.position.y;
    closest_point_msg.point.z = closet_traj_point.pose.position.z;
    pub_closest_point_->publish(closest_point_msg);
